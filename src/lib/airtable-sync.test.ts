  ...
  it("maps a customer enquiry without CRM-owned fields", () => {
    const fields = mapCustomerEnquiryToAirtableFields({
      ...
      questionnaire_answers: {
        ...
        q3: ["online"],
        q4: "during-the-next-few-weeks",
        q5: "Quiet, restorative options.",
      },
      source: "website",
      status: "new",
    ...
    expect(fields).toMatchObject({
      ...
      fld1SkYYFHVWVS5vm: "Just me",
      fld4VREmRcgNxjjqV: "Stress & emotional wellbeing\nSleep",
      fldZ24tJovF4pJzna: "Online",
      fldJE2lMOO8jFQADG: "During the next few weeks",
      fld7eU2fiIYsbgFKn: "Quiet, restorative options.",
