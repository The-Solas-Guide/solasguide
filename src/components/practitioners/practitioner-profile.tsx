...
type ProfileTag = { label: string; href?: string };
              ...
              <script
                ...
                dangerouslySetInnerHTML={{
                  __html: JSON.stringify(
                    getPractitionerJsonLd(practitioner),
                  ).replace(/</g, "\\u003c"),
                }}
              />
            ) : null}
                ...
                <dl className="mt-6 border-t border-border/80">
                  ...
                  {practitioner.significantTraining?.length ? (
                    <div className={dataRowClassName}>
                      ...
                      <dd>
                        <CredentialList
                          items={practitioner.significantTraining}
                        />
                      </dd>
                    </div>
                  ) : null}
              ...
              <div className="grid border-t border-border lg:grid-cols-[1.2fr_0.9fr]">
                {hasEditorialDetails ? (
                  ...
                  >
                    ...
                    {modalities.length ? (
                      <section
                        aria-labelledby="specific-modalities-heading"
                        className="mt-12"
                      >
                        <h2
