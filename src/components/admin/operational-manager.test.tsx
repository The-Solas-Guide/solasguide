  ...
  it("keeps workflow counts scoped to search and archive filters", () => {
    ...
    render(
      <OperationalManager
        ...
        initialRecords={workflowRecords}
      />,
    );
    const tabs = screen.getByTestId("admin-status-navigation");
    expect(tabs.textContent).toContain("All workflows2");
    expect(tabs.textContent).toContain("New1");
    expect(tabs.textContent).toContain("Contacted1");
