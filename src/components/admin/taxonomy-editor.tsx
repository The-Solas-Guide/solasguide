...
export function TaxonomyEditor({ record, isNew = false }: { record: TaxonomyWithUsage | null; isNew?: boolean }) {
  ...
  const guardLifecycleAction = () => {
    ...
    toast.warning("Save or cancel your changes before archiving or restoring this taxonomy term.");
    return false;
  };
