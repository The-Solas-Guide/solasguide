...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return <th data-slot="table-head" className={cn("h-11 px-3 text-left align-middle text-xs font-semibold uppercase tracking-[0.11em] text-muted-foreground [&:has([role=checkbox])]:pr-0", className)} {...props} />;
}
